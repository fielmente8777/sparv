...
export const landingPageData = {
  ...
  accommodationData: {
    ...
    description: "Blending Modern Comfort with Goan Charm to Redefine Your Beachside Getaway",
    cards: [
      {
        name: "Deluxe Rooms",
        description:
  ...
  galleryData: {
    ...
    images: galleryData.filter((item) => item.category.toLowerCase() !== "rooms").map((item) => item.image),
    link: {
